...
namespace FloydPink.Flickr.Downloadr.UI.Controls {
    ...
    public partial class Spinner : UserControl {
        ...
        public bool Cancellable { get { return (bool) GetValue(CancellableProperty); } set { SetValue(CancellableProperty, value); } }

        public string PercentDone { get { return (string) GetValue(PercentDoneProperty); } set { SetValue(PercentDoneProperty, value); } }
        ...
        private void CancelButtonClick(object sender, RoutedEventArgs e) {
            ...
            RaiseEvent(new RoutedEventArgs {
                RoutedEvent = SpinnerCanceledEvent
            });
        }
    }
}
